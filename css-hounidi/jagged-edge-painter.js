class JaggedEdgePainter {
  ...
  paint(ctx, size, props) {
    // console.info('jagged-edge-painter', ctx, size, props)
    let toothWidth = props.get('width').value;
    let toothHeight = props.get('height').value;

    // console.info('jagged-edge-painter', toothWidth, toothHeight)
